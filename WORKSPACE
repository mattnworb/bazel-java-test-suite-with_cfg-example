...
maven_install(
    artifacts = [
        ...
        "org.junit.platform:junit-platform-suite-commons:1.11.3",
        "org.junit.platform:junit-platform-suite-engine:1.11.3",
        "org.junit.platform:junit-platform-testkit:1.11.3",
...
http_archive(
    name = "with_cfg.bzl",
    sha256 = "2e09939d8a404da11a4fc1b7931ce1d76541a4c53970138cf0a4a50c4b257e7b",
    strip_prefix = "with_cfg.bzl-0.10.1",
    url = "https://github.com/fmeum/with_cfg.bzl/releases/download/v0.10.1/with_cfg.bzl-v0.10.1.tar.gz",
)
