...
maven_install(
    artifacts = [
        ...
        "org.junit.jupiter:junit-jupiter-migrationsupport:5.10.3",
        ...
        "org.junit.platform:junit-platform-jfr:1.10.3",
        ...
        "org.junit.platform:junit-platform-suite-commons:1.10.3",
        "org.junit.platform:junit-platform-suite-engine:1.10.3",
        "org.junit.platform:junit-platform-testkit:1.10.3",
...
http_archive(
    ...
    urls = ["https://github.com/bazelbuild/rules_java/releases/download/7.7.2/rules_java-7.7.2.tar.gz"],
)
